...
public class ProjectDAO {
    ...
    public static List<Project> selectAllProject() throws ClassNotFoundException, SQLException {
        ...
        query.append(" use QLNS_JAVA2 SELECT dbo.Projects.ProjectID, dbo.Projects.ProjectName, COUNT(dbo.Employees.EmployeeID) AS NumOfEmployee");
        ...
        query.append(" use QLNS_JAVA2 SELECT dbo.Projects.ProjectID,COUNT(dbo.Transfers.ToProjectID) AS ToDepartmentCount");
        ...
        query = new StringBuilder();
        query.append(" use QLNS_JAVA2 SELECT dbo.Projects.ProjectID,COUNT(dbo.Transfers.ToProjectID) AS FromDepartmentCount");
        query.append(" FROM dbo.Projects,dbo.Transfers");
        ...
        while (resultSet1.next()) {
            ...
            project.setProjectName(resultSet1.getString("ProjectName"));
    ...
    public static int insertProject(Project project) throws SQLException, ClassNotFoundException {
        ...
        Connection conn = EmpConnection.getConnection();
        StringBuilder query = new StringBuilder();
        query.append("use QLNS_JAVA2 INSERT INTO  [dbo].[Projects]([ProjectName])");
        query.append(" VALUES(?)");
        ...
        pStmt = conn.prepareStatement("use QLNS_JAVA2 SELECT Max(ProjectID) AS MaxID FROM Projects");
    ...
    public static void updateProject(Project project) throws SQLException, ClassNotFoundException {
        ...
        query.append("use QLNS_JAVA2 UPDATE  [dbo].[Projects] SET [ProjectName] = ?");
    ...
    public static void deleteProject(int ProjectID) throws SQLException, ClassNotFoundException {
        Connection conn = EmpConnection.getConnection();
        PreparedStatement pStmt = conn.prepareStatement("use QLNS_JAVA2 DELETE FROM Projects WHERE ProjectID = " + ProjectID);
        pStmt.executeUpdate();
        EmpConnection.closePreparedStatement(pStmt);
        EmpConnection.closeConnection(conn);
    }
