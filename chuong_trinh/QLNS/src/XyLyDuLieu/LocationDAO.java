...
public class LocationDAO {
    ...
    public static List<Location> selectAllLocation() throws SQLException, ClassNotFoundException {
        ...
        query.append(" use QLNS_JAVA2 SELECT Locations.*,COUNT(Employees.EmployeeID) AS NumOfEmployee");
        ...
        query.append(" use QLNS_JAVA2 SELECT Locations.LocationID, COUNT(Transfers.TransferID) AS ToLocationCount");
        ...
        query = new StringBuilder();
        query.append(" use QLNS_JAVA2 SELECT Locations.LocationID, COUNT(Transfers.TransferID) AS FromLocationCount");
        query.append(" FROM Locations, Transfers");
        ...
        while (resultSet1.next()) {
            ...
            project.setLocationName(resultSet1.getString("LocationName"));
    ...
    public static int insertLocation(Location location) throws ClassNotFoundException, SQLException {
        ...
        query.append("use QLNS_JAVA2 INSERT INTO  [dbo].[Locations] ([LocationName],[LocationAllowance]) ");
        query.append(" VALUES (?,?)");
    ...
    public static void updateLocation(Location location) throws SQLException, ClassNotFoundException {
        ...
        query.append("use QLNS_JAVA2 UPDATE  [dbo].[Locations]");
    ...
    public static void deleteLocation(int LocationID) throws SQLException, ClassNotFoundException {
        Connection conn = EmpConnection.getConnection();
        PreparedStatement pStmt = conn.prepareStatement("use QLNS_JAVA2 DELETE FROM Locations WHERE LocationID = " + LocationID);
        pStmt.executeUpdate();
        EmpConnection.closePreparedStatement(pStmt);
        EmpConnection.closeConnection(conn);
    }
