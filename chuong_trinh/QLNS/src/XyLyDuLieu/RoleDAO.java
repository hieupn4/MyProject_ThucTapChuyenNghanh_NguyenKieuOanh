...
public class RoleDAO {
    /*selectAllRole get all of Role from Roles table, after that insert all record into List<Role>*/
    ...
    public static List<Role> selectAllRole() throws ClassNotFoundException, SQLException {
        ...
        query.append("use QLNS_JAVA2 SELECT Roles.RoleID, Roles.RoleName,Roles.RoleAllowance, COUNT(Employees.EmployeeID) AS NumOfEmployee");
    ...
    public static int insertRole(Role role) throws SQLException, ClassNotFoundException {
        ...
        Connection conn = EmpConnection.getConnection();
        StringBuilder query = new StringBuilder();
        query.append(" use QLNS_JAVA2 INSERT INTO  [dbo].[Roles] ([RoleName],[RoleAllowance] )");
        query.append(" VALUES(?,?)");
        ...
        //Get New ID
        pStmt = conn.prepareStatement(" use QLNS_JAVA2 SELECT MAX(RoleId) AS MaxID FROM Roles");
    ...
    public static void updateRole(Role role) throws ClassNotFoundException, SQLException {
        ...
        query.append("use QLNS_JAVA2 UPDATE  [dbo].[Roles]");
    ...
    public static void deleteRole(int RoleID) throws SQLException, ClassNotFoundException {
        ...
        PreparedStatement pStmt = conn.prepareStatement("use QLNS_JAVA2 DELETE FROM roles WHERE RoleID = " + RoleID);
        pStmt.execute();
